...
<h1 class="app-page-title">Employers</h1>
            ...
            <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">Ajouter ici un nouveau employer</div>
	                </div>
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    
						    <div class="app-card-body">
							<form class="settings-form" method="POST" action="{{ route('employer.store') }}" enctype="multipart/form-data">
                                @csrf
                                @method('POST')

                                    <div class="mb-3">
									    <label for="setting-input-3" class="form-label">Sérvice</label>
    ...
    @endforeach
								    ...
								    <div class="mb-3">
									    ...
									    <input type="text" class="form-control" id="setting-input-1" name="nom" value="{{ old('nom') }}" required>
									@error('nom')
									<div class="text-danger">{{ $message }}</div>
									@enderror
									</div>
									<div class="mb-3">
									    ...
									    <input type="text" class="form-control" id="setting-input-2" name="prenom" value="{{ old('prenom') }}" required>
									</div>
									<!--
                                    <div class="mb-3">
									    <label for="setting-input-2" class="form-label">Date de naissance</label>
									    <input type="date" class="form-control" id="setting-input-2" name="date_naissance" max="{{ date('Y-m-d') }}" value="{{ old('date_naissance') }}" required>
									</div>
									-->
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="text" class="form-control" id="setting-input-2" name="contact" value="{{ old('contact') }}" required>
									@error('contact')
									<div class="text-danger">{{ $message }}</div>
									@enderror
									</div>
        ...
        @error('photos')
            <div class="text-danger">{{ $message }}</div>
        @enderror
										<!--<input type="text" name="photos" accept="image/*" class="form-control" id="setting-input-2" value="{{ old('photos') }}" required>-->
									</div>
